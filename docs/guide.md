...
?> If you have persistent headers or query parameters you'd like to set, then consider registering the API endpoint with Restish rather than exporting environment variables. Find out how in the [API-specific commands](#api-specific-commands) section below.
